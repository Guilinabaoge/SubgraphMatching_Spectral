...
//    std::string input_iseigen = command.getEigenOrNot();
//    std::string input_tops = command.getHowManyEigen();
//    /**
...
//        int sum =0;
//        cout<<"Candidate vertices number: "<<accumulate(candidates_count,candidates_count+query_graph->getVerticesCount(),sum);
