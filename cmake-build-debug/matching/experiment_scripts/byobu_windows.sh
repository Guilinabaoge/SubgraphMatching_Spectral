...
byobu select-pane -t 0
byobu send-keys "./wordnet_d16.sh" Enter

byobu select-pane -t 1
byobu send-keys "./wordnet_d20.sh" Enter

byobu select-pane -t 2
byobu send-keys "./wordnet_s16.sh" Enter

byobu select-pane -t 3
byobu send-keys "./wordnet_s20.sh" Enter
